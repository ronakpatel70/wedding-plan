class LocationsController < BaseController
  ...
  def destroy
    @location.destroy
    respond_to do |format|
      format.html { redirect_to locations_url, flash: { warning: "Location was deleted." } }
  ...
  private
    ...
    def location_params
      params.require(:location).permit(:name, :handle, :address_attributes => [:name, :street, :city, :state, :zip])
    end
end
